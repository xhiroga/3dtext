          ...
          <footer className="mt-16 pt-8 border-t border-gray-200 text-center">
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-gray-500">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 underline decoration-current underline-offset-2 hover:opacity-80 transition-opacity"
                onClick={() => {
                  // Google Analytics イベント送信
                  sendGAEvent("sponsor_link_click", {
                    event_category: "engagement",
                    event_label: "footer_sponsor_link",
                  });
                }}
              >
                スポンサーを募集しています
            ...
            <p className="mt-2 text-xs text-gray-400">
              アクセス解析にGoogle Analyticsを使用しています。
            </p>
          </footer>
        </div>
      </div>
